...
class Module_Settings extends Module
{
	...
	public function install()
	{
		...
		$settings = array(
            ...
            /**
             *  Add a setting column for google service account email
             *  slug: ga_service_account_email
             *  @since 2016/01/23
             */
			'ga_service_account_email' => array(
				'title' => 'Google Service Account E-mail',
				'description' => 'E-mail address used for Google Service Account, we need this to show the Google Analytics graph on the dashboard.',
				'type' => 'text',
				'default' => '',
				'value' => '',
				'options' => '',
            ...
            /**
             *  Add a setting column for google service account private key
             *  slug: ga_service_account_private_key
             *  @since 2016/01/23
             */
			'ga_service_account_private_key' => array(
				'title' => 'Google Service Account Private Key',
				'description' => 'Private key used for Google Service Account, we need this to show the Google Analytics graph on the dashboard.',
				'type' => 'textarea',
				'default' => '',
				'value' => '',
				'options' => '',
