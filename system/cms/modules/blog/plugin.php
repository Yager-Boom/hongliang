...
class Plugin_Blog extends Plugin
{
	...
	public $description = array(
        ...
        'fr' => 'Un plugin permettant d\'afficher des informations comme les catégories et project du blog.'
	);
		...
		$info = array(
			'posts' => array(
				'description' => array(// a single sentence to explain the purpose of this method
                    ...
                    'fr' => 'Permet d\'afficher des project de blog en les filtrants par catégorie.'
				),
			...
			'count_posts' => array(
				'description' => array(
                    ...
                    'fr' => 'Permet de compter les project de blog qui remplissent certaines conditions spécifiées.'
				),
				'single' => true,
				'double' => false,
				'variables' => '',
			...
			'tags' => array(
				'description' => array(
                    ...
                    'fr' => 'Récupère la liste de tout les tags qui ont été utilisés dans les project.'
				),
				'single' => false,
				'double' => true,
				'variables' => 'title|url',
